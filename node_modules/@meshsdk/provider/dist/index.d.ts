import { IFetcher, IListener, ISubmitter, AccountInfo, UTxO, AssetMetadata, BlockInfo, Asset, Protocol, TransactionInfo, IEvaluator, Action, Network } from '@meshsdk/common';
...
declare class BlockfrostProvider implements IFetcher, IListener, ISubmitter {
...
declare class YaciProvider implements IFetcher, IListener, ISubmitter {
    private readonly _axiosInstance;
    /**
    ...
    evaluateTx(txHex: string): Promise<string>;
    private fetchPlutusScriptCBOR;
    private fetchNativeScriptJSON;
}
