...
* @returns {string}
*/
export function calculate_tx_hash(tx_hex: string): string;
/**
* @param {string} tx_hex
* @param {JsVecString} signing_keys
* @returns {string}
*/
export function sign_transaction(tx_hex: string, signing_keys: JsVecString): string;
/**
* @param {string} tx_hex
* @returns {string}
*/
...
*/
export function js_serialize_tx_body(mesh_tx_builder_body_json: string, params_json: string): TxBuildResult;
/**
